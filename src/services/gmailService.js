...
// ── 3MB ולא 5MB ──
// הקובץ נשלח כ-base64 (×4/3) דרך /api/gemini, ו-Vercel דוחה גוף מעל 4.5MB.
// ב-5MB קובץ היה עובר את הסינון כאן ונכשל ב-413 בשרת — כשל שהגיע למשתמש
// כ"לא הצלחנו לפענח". 3MB ⟵ ~4MB אחרי קידוד, מתחת לתקרת השרת (4.4MB).
// פוליסת PassportCard האמיתית שוקלת 1.1MB.
