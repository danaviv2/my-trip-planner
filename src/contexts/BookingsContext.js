...
const PURGEABLE = {
  ...
  // אטרקציה בלי תאריך, בלי שעה ובלי מקום אינה ניתנת לשיוך ואין בה מה
  // להציג. היא נכללה כאן בהחלטת המשתמש (23.8.2026), אחרי שההדרה
  // המקורית של מלון ואטרקציה נשקלה מחדש: שם של מלון הוא תמיד ספציפי
  // ("Hotel Sant'Agata") ולכן מזוהה ונמחק ידנית, בעוד ששם של אטרקציה
  // הוא לעיתים גנרי לגמרי ("שובר כניסה") ואינו אומר דבר.
  //
